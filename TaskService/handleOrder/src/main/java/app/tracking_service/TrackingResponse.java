...
@XmlType(name = "TrackingResponse", propOrder = {
    "status",
    "currentLocation",
    "additionalDetail"
})
public class TrackingResponse {
    ...
    @XmlElementRef(name = "status", namespace = "tracking_service.app", type = JAXBElement.class, required = false)
    protected JAXBElement<String> status;
    @XmlElementRef(name = "current_location", namespace = "tracking_service.app", type = JAXBElement.class, required = false)
    protected JAXBElement<String> currentLocation;
    @XmlElementRef(name = "additional_detail", namespace = "tracking_service.app", type = JAXBElement.class, required = false)
