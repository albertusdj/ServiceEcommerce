 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "soa.logistic.order", wsdlLocation = "file:/C:/Users/albert/workspace/handleOrder/src/main/java/com/eCommerce/service/handleOrder/place-order.xml")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("soa.logistic.order", "OrderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/albert/workspace/handleOrder/src/main/java/com/eCommerce/service/handleOrder/place-order.xml");
    ...
    public Application getApplication() {
        return super.getPort(new QName("soa.logistic.order", "Application"), Application.class);
    }
    ...
    public Application getApplication(WebServiceFeature... features) {
        return super.getPort(new QName("soa.logistic.order", "Application"), Application.class, features);
    }
